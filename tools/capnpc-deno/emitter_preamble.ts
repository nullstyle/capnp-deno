 ...
 */
export function encodeStructMessageWithCaps<T extends Record<string, unknown>>(
  descriptor: StructDescriptor<T>,
  value: T,
 ...
 */
export function decodeStructMessageWithCaps<T extends Record<string, unknown>>(
  descriptor: StructDescriptor<T>,
  bytes: Uint8Array,
  capTable: PreambleCapDescriptor[],
): T {
